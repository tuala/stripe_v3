...
class CheckoutCompletedEventAction implements ActionInterface, GatewayAwareInterface, CheckoutCompletedInformationProvider
{
    ...
    private function handleEvent(Event $event): void
    {
        ...
        $intent = ($checkoutSession->payment_intent) ? $checkoutSession->payment_intent : $checkoutSession->setup_intent;
        $this->completePaymentDetails($this->status->getFirstModel(), $checkoutSession->id, $intent);
    }
