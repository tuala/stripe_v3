...
class CaptureAction implements ActionInterface, GatewayAwareInterface
{
    ...
    public function execute($request)
    {
        ...
        $this->handleIfPaymentDone($request->getToken(), $model);
     ...
     */
    private function handleIfPaymentDone(TokenInterface $token, $model): void
    {
    ...
    private function pollFullfilledPayments(TokenInterface $token): void
    {
        ...
        $fullfilledPayments = new PollFullfilledPayments($eventsFilter);
        $this->gateway->execute($fullfilledPayments);

        $eventsIterator = $fullfilledPayments->getEvents()->autoPagingIterator();
