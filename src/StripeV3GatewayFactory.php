...
use App\PaymentGateway\Action\Api\CreateCustomerAction;
...
class StripeV3GatewayFactory extends GatewayFactory
{
    ...
    protected function populateConfig(ArrayObject $config)
    {
        $config->defaults([
            ...
            'payum.action.checkout_completed'        => new CheckoutCompletedEventAction(), // custom action
